 ...
 <link rel="icon" type="image/x-icon" href="/img/favicon.png"><!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="min-height: 90vh !important"> 
            @if (Route::has('login'))
